...
class FeedbackTests(TestCase):
    ...
    def test_feedback_can_be_sent_if_valid_message(self):
        ...
        self.assertEquals(ServiceFeedback.objects.all()[0].content, test_feedback)
        self.assertEquals(list(response.context['messages'])[0].message, success_message)
    ...
    def test_feedback_cannot_be_sent_if_too_long_message(self):
        ...
        self.assertEquals(list(response.context['messages'])[0].message, "Message: Maximum allowed length is 4096 characters")